 ...
 * {@link android.database.Cursor} row to {@link String} or boxed
 * primitive type.
 *
...
public final class SingleRowTransforms {
  ...
  /**
   * Constructs new {@link com.getbase.android.db.cursors.SingleRowTransforms.Builder} for specified {@code columnName}.
   */
  ...
  public static class Builder {
     ...
     * Constructs {@link com.google.common.base.Function} converting the
     * specified column in {@link android.database.Cursor} row to
     * {@link Boolean}, by fetching column as integer. The Function
